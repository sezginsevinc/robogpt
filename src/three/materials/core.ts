...
/**
 * EmberGlow — CORE-01's living surface.
 * Fresnel ember rim over a cold graphite body; simplex-noise breathing
 * driven by uPulse; uEnergy is the visit's accumulated curiosity.
 */
...
${NOISE}
void main() {
  float n = snoise(position * 1.8 + vec3(0.0, uTime * 0.25, 0.0));
  vNoise = n;
  vec3 pos = position + normal * n * 0.07 * uPulse;
